...
const FeatureCard2: React.FC<FeatureCard2Props> = ({
  ...
  return (
    <div
      className={`flex flex-col justify-between gap-3 ${className} border border-gray-200 px-4 py-4 rounded-lg min-h-[15rem]`}
    >
      ...
      <button className="flex items-start justify-start bg-white text-black text-sm font-semibold">
