      ...
      <WorldMap
        dots={[
          ...
          },
          {
            ...
            end: { lat: 51.5074, lng: -3.1578 }, // Lisbon
          },
          // {
          ...
          {
            start: { lat: 30.5595, lng: 22.9375 }, // South Africa
            end: { lat: 9.0820, lng: 8.6753 }, // Nigeria
          },
          {
            start: { lat: 23.8859, lng: 45.0792 }, // Saudi Arabia
          ...
          {
            start: { lat: 39.916668, lng: 116.383331}, // Cgina
            end: { lat: -35.8136, lng: 144.9631 }, // Melbourne
          },
        ]}
      />
    </section>
