...
const Button: React.FC<ButtonProps> = ({ children,  variant = 'solid', onClick, className}) => {
    const baseStyles = 'px-4 py-2 rounded-md text-sm transition ease-in-out delay-150 hover:scale-110';
